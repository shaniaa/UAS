<?php /* C:\xampp\htdocs\laravel\pertemuan11.2\resources\views/products/index.blade.php */ ?>
...
<div class="container">
    ...
    <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $idx => $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        ...
        <div class="col">
            <div class="card">
            <!-- <img src="https://static.gamespot.com/uploads/scale_super/1578/15789737/3515432-endgamedek.jpg" class="card-img-top" alt="..."> -->
