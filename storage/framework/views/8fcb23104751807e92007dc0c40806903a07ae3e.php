<?php /* C:\xampp\htdocs\laravel\pertemuan10\resources\views/carts/index.blade.php */ ?>
...
<div class="container">
    ...
    <table id="cart" class="table table-hover table-condensed">
        ...
        <tr>
            <td data-th="Product">
                <div class="row">
                    <div class="col-sm-3 hidden-xs"><img src="<?php echo e(route('products.image', ['imageName' => $product['image-url']])); ?>" width="100" height="100" class="img-responsive"/></div>
                    <div class="col-sm-9">
